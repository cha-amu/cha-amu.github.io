...
- 자료 데이터는 `https://cha-amu.github.io/storage/manifests/assets.json`과 Sheets override를 합쳐 만든다.
...
GET https://cha-amu.github.io/storage/manifests/assets.json
...
- 관리자 세션은 10분 동안 활동이 없으면 만료하고, 사용 중에는 자동으로 갱신한다.
