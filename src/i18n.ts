...
const ko = {
  ...
  'archive.title': '자료',
  'archive.controls': '자료 검색 및 정렬',
  'archive.search': '자료 검색',
  'archive.searchQuery': '자료 검색어',
  'archive.sort': '자료 정렬',
  'archive.sortLatest': '최신순',
  'archive.sortOldest': '오래된순',
  'archive.sortName': '이름순',
  ...
  'search.total': '총 {count}개',
  'search.postsGroup': '아무 글 {count}개',
  'search.archiveGroup': '자료 {count}개',
  'search.resultPost': '아무 글',
  'search.resultArchive': '자료',
  'search.loadMorePosts': '아무 글 {count}개 더보기',
  'search.loadMoreArchive': '자료 {count}개 더보기',
  'guestbook.title': '방명록',
  ...
  'admin.bulk.selected': '{count}개 선택',
  'admin.bulk.selectAll': '전체 선택',
  'admin.bulk.selectItem': '{name} 선택',
  'admin.bulk.status': '일괄 상태',
  'admin.bulk.apply': '적용',
  'admin.bulk.processing': '처리 중',
  'admin.bulk.deleteSelected': '선택 항목 영구삭제',
  ...
  'admin.posts.bulkUpdated': '글 {count}개를 {status} 상태로 변경했습니다.',
  'admin.posts.bulkUpdateFailed': '글 상태를 일괄 변경하지 못했습니다.',
  'admin.posts.deleteConfirm': '글 {count}개를 영구삭제할까요?\n삭제한 글은 복구할 수 없습니다.',
  'admin.posts.deleted': '글 {count}개를 삭제했습니다. 저장소 원본은 동기화 과정에서 자동 정리됩니다.',
  'admin.posts.deleteFailed': '글을 삭제하지 못했습니다.',
  'admin.posts.deleteOne': '이 글 영구삭제',
  ...
  'admin.assets.bulkUpdated': '자료 {count}개를 {status} 상태로 변경했습니다.',
  'admin.assets.bulkUpdateFailed': '자료 표시 상태를 일괄 변경하지 못했습니다.',
  ...
  'admin.guestbook.bulkUpdated': '방명록 {count}개를 {status} 상태로 변경했습니다.',
  'admin.guestbook.bulkUpdateFailed': '방명록 상태를 일괄 변경하지 못했습니다.',
  'admin.guestbook.deleteConfirm': '방명록 {count}개를 영구삭제할까요?\n글은 복구할 수 없으며, 기존 IP 차단 기록은 유지됩니다.',
  'admin.guestbook.deleted': '방명록 {count}개를 영구삭제했습니다.',
  'admin.guestbook.deleteFailed': '방명록을 삭제하지 못했습니다.',
  'admin.guestbook.deleteOne': '이 방명록 영구삭제',
  ...
  'admin.hide.bulkTitle': '방명록 일괄 숨기기',
  'admin.hide.description': '{name}님의 글을 공개 목록에서 숨깁니다.',
  'admin.hide.bulkDescription': '선택한 방명록 {count}개를 같은 사유로 숨깁니다.',
...
const en: Record<TranslationKey, string> = {
  ...
  'archive.controls': 'Archive search and sorting',
  'archive.search': 'Search archive',
  'archive.searchQuery': 'Archive search query',
  'archive.sort': 'Sort archive',
  'archive.sortLatest': 'Latest',
  'archive.sortOldest': 'Oldest',
  'archive.sortName': 'Name',
  ...
  'search.postsGroup': 'Posts ({count})',
  'search.archiveGroup': 'Archive ({count})',
  'search.resultPost': 'Post',
  'search.resultArchive': 'Archive',
  'search.loadMorePosts': 'Load more posts ({count})',
  'search.loadMoreArchive': 'Load more archive items ({count})',
  ...
  'admin.bulk.selectItem': 'Select {name}',
  'admin.bulk.status': 'Bulk status',
  'admin.bulk.apply': 'Apply',
  'admin.bulk.processing': 'Working',
  'admin.bulk.deleteSelected': 'Permanently delete selected items',
  ...
  'admin.posts.bulkUpdated': 'Changed {count} posts to {status}.',
  'admin.posts.bulkUpdateFailed': 'Could not update the selected posts.',
  'admin.posts.deleteConfirm': 'Permanently delete {count} posts?\nDeleted posts cannot be restored.',
  'admin.posts.deleted': 'Deleted {count} posts. Storage originals will be removed by the sync process.',
  'admin.posts.deleteFailed': 'Could not delete the posts.',
  'admin.posts.deleteOne': 'Permanently delete this post',
  ...
  'admin.assets.bulkUpdated': 'Changed the display status of {count} archive items to {status}.',
  'admin.assets.bulkUpdateFailed': 'Could not update the selected archive items.',
  ...
  'admin.guestbook.bulkUpdated': 'Changed {count} guestbook messages to {status}.',
  'admin.guestbook.bulkUpdateFailed': 'Could not update the selected guestbook messages.',
  'admin.guestbook.deleteConfirm': 'Permanently delete {count} guestbook messages?\nMessages cannot be restored. Existing IP block history will be retained.',
  'admin.guestbook.deleted': 'Permanently deleted {count} guestbook messages.',
  'admin.guestbook.deleteFailed': 'Could not delete the guestbook messages.',
  'admin.guestbook.deleteOne': 'Permanently delete this guestbook message',
  ...
  'admin.hide.bulkTitle': 'Hide selected guestbook messages',
  'admin.hide.description': 'Hide the message by {name} from the public list.',
  'admin.hide.bulkDescription': 'Hide {count} selected guestbook messages with the same reason.',
