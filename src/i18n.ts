...
const ko = {
  ...
  'things.refreshing': '최신 링크 확인 중',
  'things.empty': '아직 공개된 링크가 없습니다.',
  'things.list': '사이트와 앱 링크',
  ...
  'errors.thingsLoad': '아무거 링크를 불러오지 못했습니다.',
  ...
  'mock.tag.archive': '자료',
  'admin.title': '관리자',
  'admin.lead': '글과 링크 작성, 자료 표시 정보, 방명록 관리를 처리합니다.',
  'admin.menu': '관리자 메뉴',
  'admin.logout': '로그아웃',
  'admin.session.remaining': '세션 {time} 남음',
  'admin.session.autoRefresh': '사용 중 자동 갱신',
  'admin.sessionExpired': '세션이 만료되었습니다. 다시 로그인하면 작성 중인 화면으로 돌아올 수 있습니다.',
  'admin.login.title': '관리자 로그인',
  'admin.login.lead': '글과 링크 작성, 방명록 관리, 자료 표시 정보 수정을 여기서 합니다.',
  ...
  'admin.things.manage': '아무거 관리',
  'admin.things.help': '사이트나 앱 링크를 추가하고 공개 상태와 순서를 관리합니다.',
  'admin.things.loadFailed': '링크 목록을 불러오지 못했습니다.',
  'admin.things.loading': '불러오는 중',
  'admin.things.loadingList': '링크 목록을 불러오는 중입니다.',
  'admin.things.empty': '아직 저장된 링크가 없습니다.',
  'admin.things.new': '새 링크 추가',
  'admin.things.edit': '링크 수정',
  'admin.things.list': '링크 목록',
  'admin.things.titleField': '이름',
  'admin.things.urlField': '사이트 또는 앱 URL',
  'admin.things.urlHelp': 'http:// 또는 https://로 시작하는 주소를 입력하세요.',
  'admin.things.imageField': '대표 이미지 URL (선택)',
  'admin.things.imageHelp': '비워 두면 텍스트 카드로 표시됩니다. HTTPS URL을 권장하며, 직접 입력하거나 저장소 이미지 목록에서 고를 수 있습니다.',
  'admin.things.imageOptionsLoading': '저장소 이미지 목록을 불러오는 중입니다.',
  'admin.things.imageOptionsCount': '저장소 이미지 {count}개를 선택할 수 있습니다.',
  'admin.things.imageOptionsEmpty': '선택할 수 있는 저장소 이미지가 없습니다. URL은 직접 입력할 수 있습니다.',
  'admin.things.imagePreviewAlt': '대표 이미지 미리보기',
  'admin.things.imagePreviewFailed': '이미지 미리보기를 불러오지 못했습니다. 주소를 확인해 주세요.',
  'admin.things.descriptionField': '설명',
  'admin.things.statusField': '상태',
  'admin.things.sortOrderField': '정렬값',
  'admin.things.titleRequired': '이름을 입력하세요.',
  'admin.things.urlInvalid': '올바른 http 또는 https 주소를 입력하세요.',
  'admin.things.imageInvalid': '대표 이미지는 올바른 http 또는 https 주소를 입력하거나 비워 두세요.',
  'admin.things.sortOrderInvalid': '정렬값은 정수로 입력하세요.',
  'admin.things.saved': '링크를 저장했습니다.',
  'admin.things.saveFailed': '링크를 저장하지 못했습니다.',
  'admin.things.deleteConfirm': '“{title}” 링크를 영구삭제할까요?\n삭제한 링크는 복구할 수 없습니다.',
  'admin.things.deleted': '링크를 삭제했습니다.',
  'admin.things.deleteFailed': '링크를 삭제하지 못했습니다.',
  'admin.things.deleteOne': '이 링크 영구삭제',
  ...
  'admin.assets.note': '이미지 파일은 저장소에서 관리합니다. 숨김은 자료 목록에서만 감추며, 글에 넣은 이미지는 계속 표시됩니다.',
...
const en: Record<TranslationKey, string> = {
  ...
  'things.refreshing': 'Checking for updated links',
  'things.empty': 'There are no public links yet.',
  'things.list': 'Site and app links',
  ...
  'errors.thingsLoad': 'Could not load Things links.',
  ...
  'admin.title': 'Admin',
  'admin.lead': 'Manage posts, links, archive display details, and guestbook entries.',
  'admin.menu': 'Admin menu',
  'admin.logout': 'Log out',
  'admin.session.remaining': 'Session {time} remaining',
  'admin.session.autoRefresh': 'Refreshes automatically while active',
  'admin.sessionExpired': 'Your session expired. Log in again to return to your draft.',
  'admin.login.title': 'Admin login',
  'admin.login.lead': 'Manage posts, links, guestbook entries, and archive display details here.',
  ...
  'admin.things.manage': 'Manage Things',
  'admin.things.help': 'Add site or app links and manage their visibility and order.',
  'admin.things.loadFailed': 'Could not load the link list.',
  'admin.things.loading': 'Loading',
  'admin.things.loadingList': 'Loading the link list.',
  'admin.things.empty': 'No links have been saved yet.',
  'admin.things.new': 'Add link',
  'admin.things.edit': 'Edit link',
  'admin.things.list': 'Links',
  'admin.things.titleField': 'Name',
  'admin.things.urlField': 'Site or app URL',
  'admin.things.urlHelp': 'Enter an address beginning with http:// or https://.',
  'admin.things.imageField': 'Representative image URL (optional)',
  'admin.things.imageHelp': 'Leave this blank for a text-only card. HTTPS is recommended; enter a URL or choose an image from the storage list.',
  'admin.things.imageOptionsLoading': 'Loading storage images.',
  'admin.things.imageOptionsCount': '{count} storage images are available.',
  'admin.things.imageOptionsEmpty': 'No storage images are available. You can still enter a URL directly.',
  'admin.things.imagePreviewAlt': 'Representative image preview',
  'admin.things.imagePreviewFailed': 'The image preview could not be loaded. Check the address.',
  'admin.things.descriptionField': 'Description',
  'admin.things.statusField': 'Status',
  'admin.things.sortOrderField': 'Sort order',
  'admin.things.titleRequired': 'Enter a name.',
  'admin.things.urlInvalid': 'Enter a valid HTTP or HTTPS address.',
  'admin.things.imageInvalid': 'Enter a valid HTTP or HTTPS representative image address, or leave it blank.',
  'admin.things.sortOrderInvalid': 'Enter an integer for the sort order.',
  'admin.things.saved': 'Saved the link.',
  'admin.things.saveFailed': 'Could not save the link.',
  'admin.things.deleteConfirm': 'Permanently delete the “{title}” link?\nDeleted links cannot be restored.',
  'admin.things.deleted': 'Deleted the link.',
  'admin.things.deleteFailed': 'Could not delete the link.',
  'admin.things.deleteOne': 'Permanently delete this link',
  ...
  'admin.assets.note': 'Files are managed in storage. Hidden files leave the archive list but remain visible when embedded in posts.',
